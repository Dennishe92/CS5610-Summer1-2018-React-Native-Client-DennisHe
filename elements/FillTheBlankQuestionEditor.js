...
class FillTheBlankQuestionEditor extends React.Component {
    ...
    createFillTheBlankQuestion() {
        ...
        this.QuestionService
            .createFillTheBlankQuestion(this.state.examId, tmp)
    }
    ...
    render() {
        return(
            <View>
                ...
                <TextInput
                    style={{height: 100}}
                    placeholder="fill in blank fields."
                />


                <Button onPress={this.createFillTheBlankQuestion}
...
export default FillTheBlankQuestionEditor
